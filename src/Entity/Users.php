...
class Users implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=TraducSource::class, mappedBy="users", orphanRemoval=true)
     */
    ...
    public function removeTraducSource(TraducSource $traducSource): self
    {
        if ($this->traducSources->removeElement($traducSource)) {
            ...
            if ($traducSource->getUsers() === $this) {
                $traducSource->setUsers(null);
            }
        }
